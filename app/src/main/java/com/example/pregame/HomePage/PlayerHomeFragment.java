...
public class PlayerHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_player_home, container, false);
        ...
        userType.setText(PlayerHomeActivity.userType);

        TextView teamName = view.findViewById(R.id.team_name);
        teamName.setText(PlayerHomeActivity.currentTeam.getTeamName());
